  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-20">
        ...
        <div className="w-32 h-1 bg-purple-500 mx-auto mt-4"></div>
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A showcase of the projects I have worked on across Web Development and
          Data Analytics
        </p>
      </div>
      ...
      <h3 className="text-3xl font-bold text-white mt-28 mb-4 text-center">
        Data Analytics Projects
      </h3>

      <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
        Hands-on data analytics projects focused on SQL, Python, Power BI,
